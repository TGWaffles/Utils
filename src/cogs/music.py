    ...
    async def get_video_data(url, loop=None, search=False, target_duration=None):
        ...
        if search:
            if target_duration is not None:
                title = url.split("\uFEFF")[1]
                url = url.replace("\uFEFF", "")
                plain_query = youtube_search.CustomSearch(url, youtube_search.VideoSortOrder.viewCount, limit=10)
                ...
                print(len(original_results.get("result")))
                print(len(plain_results.get("result")))
